		...
		<header class="masthead">
			...
			<nav class="navbar">
				<div class="navbar-inner">
					<div class="container">
						<ul class="nav">
							<li class="active"><a href="teste.php">Página inicial</a></li>
						</ul>
					</div>
				</div>
			</nav>
		...
		<table class="table table-hover">
			...
			<tbody>
				<tr>
					...
					<td>
						<?php echo "<a href='teste.php?acao=editar&id=" . $value->id . "'>Editar</a>"; ?>
						<?php echo "<a href='teste.php?acao=deletar&id=" . $value->id . "' onclick='deletarPaciente(value)'>Deletar</a>"; ?>
					</td>
				</tr>
			</tbody>
